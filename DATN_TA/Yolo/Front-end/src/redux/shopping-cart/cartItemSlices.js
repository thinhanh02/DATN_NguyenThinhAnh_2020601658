...
export const cartItemsSlice = createSlice({
    ...
    reducers: {
        ...
        removeAllItems: (state) => {
            state.value = []; // Xóa tất cả các sản phẩm bằng cách gán giá trị rỗng cho mảng sản phẩm trong state
...
export const { addItem, updateItem, removeItem, removeAllItems } = cartItemsSlice.actions
